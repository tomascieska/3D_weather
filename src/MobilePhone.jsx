  ...
  return (
    <group scale={30}{...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh name="Phone_Case_PhoneFace_Mat_0" castShadow receiveShadow geometry={nodes.Phone_Case_PhoneFace_Mat_0.geometry} material-color="#E3FCF3" position={[0, 0.292, 0.003]} rotation={[1.572, 0, 0]} scale={0.01} />
